...
RECEIVE_DATA(UNI_T_UT71A, es519xx)
RECEIVE_DATA(UNI_T_UT71B, es519xx)
RECEIVE_DATA(UNI_T_UT71C, es519xx)
RECEIVE_DATA(UNI_T_UT71D, es519xx)
RECEIVE_DATA(UNI_T_UT71E, es519xx)
